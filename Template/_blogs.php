...
<section id="blogs">
              <div class="container py-4">
                <h4 class="font-rubik font-size-20">Ultimas noticias</h4>
                <hr>

                <div class="owl-carousel owl-theme">
                  <div class="item">
                    <div class="card border-0 font-rale mr-5" style="width: 18rem;">
                      <h5 class="card-title font-size-16">Proximos telefonos</h5>
                      ...
                      <a href="#" class="color-second text-left">Ir aqui</a>
                    </div>
                  </div>
                  <div class="item">
                    <div class="card border-0 font-rale mr-5" style="width: 18rem;">
